...
[คำแนะนำพิเศษสำหรับการทำงาน]:
หากผู้ใช้ขอให้ "สร้างร่างหนังสือราชการ", "ร่างหนังสือ", หรือ "ร่างคำสั่ง" 
ให้คุณพิมพ์โครงสร้างของหนังสือราชการ/คำสั่ง ตามรูปแบบมาตรฐานของไทยให้ครบถ้วน 
(เช่น ที่, วันที่, เรื่อง, เรียน, อ้างถึง, สิ่งที่ส่งมาด้วย, เนื้อหา, จึงเรียนมาเพื่อโปรดพิจารณา, ลงชื่อ)
โดยจัดรูปแบบให้อ่านง่าย และใช้ข้อมูลเท่าที่มี พร้อมเว้นช่องว่าง (เช่น ...) สำหรับข้อมูลที่ผู้ใช้ต้องเติมเอง
